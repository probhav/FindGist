...
public class ProfileFragment extends Fragment implements MainViewModel.IMainViewModelListener {
    ...
    private void observeViewModel() {
        mViewModel.setListener(this);
        mViewModel.getLoginFormVisibility().observe(getViewLifecycleOwner(), visibility -> mLoginFormView.setVisibility(visibility));
        mViewModel.getLoginViewVisibility().observe(getViewLifecycleOwner(), visibility -> mLoginView.setVisibility(visibility));
        mViewModel.getProfileVisibility().observe(getViewLifecycleOwner(), visibility -> mProfileView.setVisibility(visibility));
        mViewModel.getProgressBarVisibility().observe(getViewLifecycleOwner(), visibility -> mLoginProgressBar.setVisibility(visibility));
        mViewModel.getErrorMessage().observe(getViewLifecycleOwner(), this::onErrorChanged);
        mViewModel.getUsernameError().observe(getViewLifecycleOwner(), message -> mUsernameInput.setError(message));
        mViewModel.getTokenError().observe(getViewLifecycleOwner(), message -> mTokenInput.setError(message));
        mViewModel.getUser().observe(getViewLifecycleOwner(), this::onUserLoaded);
    }
